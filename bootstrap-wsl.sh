...
# Symlink dotfiles
if [ ! -f "$HOME/dotfiles/zsh/oh-my-env.sh $HOME/.oh-my-env.sh" ]; then
...
[ ! -x "$(command -v sass)" ] && sudo npm install -g sass
[ ! -x "$(command -v tsc)" ] && sudo npm install -g typescript
[ ! -x "$(command -v webpack)" ] && sudo npm install -g webpack
[ ! -x "$(command -v webpack-cli)" ] && sudo npm install -g webpack-cli
[ ! -x "$(command -v vue)" ] && sudo npm install -g @vue/cli
...
if [ ! -d "/var/www/html/fancy-index" ]; then
  ...
  cd /var/www/html && sudo git clone https://github.com/Vestride/fancy-index.git
...
echo "- ${GREEN}Adobe Photoshop:${NC}\t https://www.adobe.com/de/products/photoshop.html"
echo "- ${GREEN}Adobe XD:${NC}\t\t https://www.adobe.com/products/xd.html#"
echo "- ${GREEN}Affinity Photo:${NC}\t https://affinity.serif.com/en-gb/photo/"
echo "- ${GREEN}Flowkey:${NC}\t\t https://www.flowkey.com/en"
echo "- ${GREEN}XING:${NC}\t\t\t https://faq.xing.com/de/windows/xing-app-f%C3%BCr-windows-10-herunterladen"
echo "- ${GREEN}FL Studio:${NC}\t\t https://www.image-line.com/flstudio"
echo "- ${GREEN}ICUE:${NC}\t\t\t https://www.corsair.com/de/de/icue"
echo "- ${GREEN}Alesis V61 Editor:${NC}\t https://www.alesis.com/products/legacy/v61"
